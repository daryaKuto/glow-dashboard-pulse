...
const collectionPath = path.join(__dirname, 'ThingsBoard_API_Collection_Fixed.json');
const environmentPath = path.join(__dirname, 'ThingsBoard_Environment.json');
...
async function runAllTests() {
  console.log('🚀 Starting ThingsBoard API Tests...\n');
