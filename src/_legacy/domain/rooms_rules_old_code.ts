 ...
 * 
 * REPLACEMENT: 
 * - Validation: src/domain/rooms/validators.ts (Zod schemas)
 * - Backend enforcement: Supabase RLS policies and database constraints
 * 
 * ORIGINAL LOCATION: src/domain/rooms/rules.ts
 * 
 * POTENTIAL FUTURE USE: If complex client-side business logic is needed
 * (e.g., pre-validation before API calls), these rules could be wired in.
 */

import { ROOM_CONSTRAINTS } from '../../domain/rooms/validators';
import { normalizeString } from '../../domain/shared/validation-helpers';
