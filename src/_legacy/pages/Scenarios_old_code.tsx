 ...
 * Replaced by: no active route (Scenarios feature removed from main routes).
 */
...
import { useScenarioRun } from '@/_legacy/state/useScenarioRun_old_code';
...
import { useScenarioLiveData } from '@/_legacy/hooks/useScenarioLiveData_old_code';
...
import type { Target } from '@/state/useTargets';
