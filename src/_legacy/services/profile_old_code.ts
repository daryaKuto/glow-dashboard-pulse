 ...
 * Replaced by: src/features/profile/repo.ts, src/features/profile/service.ts.
 */

import { supabase } from '@/integrations/supabase/client';
import type { Database } from '@/integrations/supabase/types';
import { encryptPassword, decryptPassword, hasThingsBoardCredentials } from '../../shared/lib/credentials';
