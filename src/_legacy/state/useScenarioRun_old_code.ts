 ...
 * Replaced by: no active scenario flow (Scenarios route removed).
 */
...
import { scenarioApiService } from '@/_legacy/services/scenario-api_old_code';
import { mockScenarioService } from '@/_legacy/services/scenario-mock_old_code';
import { DOUBLE_TAP_CONFIG } from '@/shared/types';
import type { ScenarioSession, ScenarioResults } from '@/shared/types';
