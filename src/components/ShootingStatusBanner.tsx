      ...
      <div className="hidden md:block">
        <div className="flex items-center justify-between p-4">
          <div className="flex items-center gap-3">
            <div className={`w-3 h-3 rounded-full ${status.color} ${hasActiveShooters ? 'animate-pulse' : ''}`}></div>
            <span className="text-sm font-medium text-brand-text font-body">
              Shooting Status: {status.fullText}
            </span>
          </div>
          <div className="flex items-center gap-4 text-sm text-brand-text/70 font-body">
            ...
            <Button 
              ...
              variant="outline" 
              onClick={onRefresh}
              className="border-brand-secondary/30 text-brand-secondary hover:bg-brand-primary hover:text-white font-body"
            >
