...
const Navbar = () => {
  ...
  const NavLinks = () => (
    <>
      <Link to="/" className="text-white hover:text-brand-lavender transition-colors">
        Home
      </Link>
      <Link to="/products" className="text-white hover:text-brand-lavender transition-colors">
        Products
      </Link>
      {user ? (
        <Link to="/dashboard" className="text-white hover:text-brand-lavender transition-colors">
          Dashboard
        </Link>
      ) : (
        <>
          <Link to="/login" className="text-white hover:text-brand-lavender transition-colors">
            Login
          </Link>
