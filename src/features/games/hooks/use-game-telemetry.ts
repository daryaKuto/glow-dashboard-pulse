/**
 * Hook to subscribe to real-time game telemetry (hits, splits, scores)
 *
 * @migrated from src/hooks/useGameTelemetry.ts
 * @see src/_legacy/README.md for migration details
 */

import { useCallback, useEffect, useMemo, useRef, useState } from 'react';
import { subscribeToGameTelemetry } from '@/features/games/lib/game-telemetry';
