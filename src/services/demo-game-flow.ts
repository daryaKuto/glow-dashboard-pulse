/**
 * Demo Game Flow Service
 * Simulates ThingsBoard device interactions for testing the game flow
 */

import { DeviceStatus, GameSession, GameHistory, DeviceGameEvent } from './device-game-flow';
