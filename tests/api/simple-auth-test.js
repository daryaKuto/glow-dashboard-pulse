...
// Test configuration
const config = {
  baseURL: process.env.VITE_TB_BASE_URL || 'https://thingsboard.cloud',
  username: process.env.VITE_TB_USERNAME || 'andrew.tam@gmail.com',
  password: process.env.VITE_TB_PASSWORD || 'dryfire2025'
};
